        ...
        <div>
          ...
          {showAdvanced && (
            <div className="mt-3 p-4 bg-ui-element/50 rounded-lg space-y-4 border border-accent-border">
              <div>
                <label htmlFor="ragSimilarityThreshold" className="block text-sm text-gray-300">Similarity Threshold: <span className="font-mono text-accent">{(formState.ragSimilarityThreshold || 0).toFixed(2)}</span></label>
                <input
                  type="range"
